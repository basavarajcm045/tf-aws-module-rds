# Oracle Development Instance Example

## Purpose

The purpose of these examples is to:

- Demonstrate real-world basic usage patterns.
...
These examples are intended for Development-grade deployments with monitoring, backups, and logging enabled.
...
cd examples/Oracle-Dev-Instance
terraform init
